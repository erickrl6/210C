...
plot(0:H, median_LP, 'm-', 'LineWidth', 2);
legend('True IRF', 'Jordà LP (no controls)', 'Location', 'NorthEast');
xlabel('Horizon (h)');
ylabel('Impulse Response of y_{t+h}');
title('Jordà Local Projection vs. True IRF');
grid on;

% Save figure
saveas(gcf, 'out/5_IRF_Jorda_y.png');
